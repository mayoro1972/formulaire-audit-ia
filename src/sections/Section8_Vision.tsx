    ...
    <div>
      <div className="audit-section-header mb-6">
        ...
        <h2 className="display-font mt-4 text-2xl font-semibold text-slate-950 md:text-3xl">
          Vision IA pour le métier
        </h2>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">
          Cette section transforme les irritants en ambition cible afin de prioriser une feuille de route.
        </p>
      </div>

      <div className="audit-card mb-5">
        <div className="mb-4 text-sm font-semibold text-slate-900">H.1 - Idéal à 6 mois</div>
        <div className="grid gap-4">
          <div>
            <label className="mb-2 block">Si une seule tâche pouvait être automatisée dans 6 mois, laquelle ?</label>
            <textarea
              value={formData.h_une}
              onChange={(event) => updateField('h_une', event.target.value)}
              placeholder="Soyez très précis sur la tâche ou le flux visé."
              rows={3}
            />
          </div>
          <div>
      ...
      <div className="audit-card mb-5">
        <div className="mb-4 text-sm font-semibold text-slate-900">H.2 - Vision à 18 mois</div>
        <div className="grid gap-4">
          <div>
            <label className="mb-2 block">À quoi ressemble votre journée type avec l’IA ?</label>
            <textarea
          ...
          <div>
            <label className="mb-2 block">Tâches totalement déléguées à l’IA</label>
            <textarea
          ...
          <div>
            <label className="mb-2 block">Expertise humaine à conserver</label>
            <textarea
      ...
      <div className="audit-card">
        <div className="mb-4 text-sm font-semibold text-slate-900">H.3 - Déploiement métier et KPI</div>
        <div className="grid gap-4">
          <div>
            <label className="mb-2 block">Comment déployer ces usages dans l’équipe ou le réseau ?</label>
            <textarea
          ...
          <div>
            <label className="mb-2 block">Quels indicateurs prouveront le succès ?</label>
            <textarea
